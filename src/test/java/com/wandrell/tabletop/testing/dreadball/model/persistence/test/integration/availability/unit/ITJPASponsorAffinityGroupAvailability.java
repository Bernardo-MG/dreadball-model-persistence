...
/**
 * Integration tests for {@link JPASponsorAffinityGroupAvailability}, checking
 * that the JPA configuration is correct.
 * <p>
 ...
 * a {@link SponsorAffinityGroupAvailabilityTestRepository}, which will be used
 * to acquire the tested entity.
 * <p>
...
public final class ITJPASponsorAffinityGroupAvailability
     ...
     */
    @Autowired
    private SponsorAffinityGroupAvailabilityTestRepository repository;
    ...
    public void test_loads() {
        final JPASponsorAffinityGroupAvailability ava;  // Tested entity
