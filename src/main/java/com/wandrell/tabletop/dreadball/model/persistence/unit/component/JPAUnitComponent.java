...
public final class JPAUnitComponent
        implements UnitComponent, PersistenceEntity, Serializable {
    ...
    public final void setComponentName(final String name) {
        checkNotNull(attributes, "Received a null pointer as name");

        this.name = name;
    }

    public final void setCost(final Integer cost) {
        checkNotNull(attributes, "Received a null pointer as cost");
    ...
    public final void setId(final Integer identifier) {
        checkNotNull(attributes, "Received a null pointer as identifier");

        id = identifier;
    }

    public final void setLocation(final JPAComponentLocation location) {
        checkNotNull(attributes, "Received a null pointer as location");
